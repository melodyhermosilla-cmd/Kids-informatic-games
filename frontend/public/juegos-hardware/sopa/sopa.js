...
async function loadWords() {
  try {
    const response = await fetch('sopa.json');
    ...
    wordsData = [
      { "word": "RAM", "image": "img/ram.webp" },
      { "word": "PLACAMADRE", "image": "img/placa madre.webp" },
      { "word": "MONITOR", "image": "img/monitor.webp" },
      { "word": "DISCODURO", "image": "img/DISCO DURO.webp" },
      { "word": "MOUSE", "image": "img/mouse.webp" },
      { "word": "HARDWARE", "image": "img/HADWARER.webp" },
      { "word": "TECLADO", "image": "img/teclado.webp" },
      { "word": "USB", "image": "img/usb.webp" },
      { "word": "GABINETE", "image": "img/gabinete.webp" },
      { "word": "IMPRESORA", "image": "img/impresora.webp" },
      { "word": "PROCESADOR", "image": "img/procesador.webp" },
      { "word": "TARJETAVideo", "image": "img/tarjetadevideo.webp" }
    ];
    initGame();
  }
}
